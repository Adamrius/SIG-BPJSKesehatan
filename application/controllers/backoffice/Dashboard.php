...
class Dashboard extends CI_Controller {
    ...
    function data_info() 
    {
        ...
        foreach ($get_kriminalitas as $key) {

            $count = $this->db->query("SELECT COUNT(id) as total FROM tb_laporan WHERE id_kriminalitas = ".$key['id']." ")->row_array();

            $row['id']           = $key['id'];
            $row['kriminalitas'] = $key['name'];
        ...
        $response['data_kriminalitas'] = $data;
