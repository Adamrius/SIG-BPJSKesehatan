<section class="section-maps">
    <div class="container-fluid gx-0">
        <div class="top-section text-dark">
            <!-- <div class="container"> -->
            <marquee direction="left" scrollamount="9" bgcolor='#00a2ff '>
                <h1>INFORMASI FASILITAS BPJS KESEHATAN TINGKAT PERTAMA KABUPATEN BANYUMAS</h1>
            </marquee>
            <!-- </div> -->
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function initMap(data_maps_array) {
            var options = {
                zoom: 11,
                center: new google.maps.LatLng(-7.450221641069655, 109.27323322638935),
